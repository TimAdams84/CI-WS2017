...
import neuralNetwork.RBFNeuron;
...
public class Main90xRBF {
	...
	public static void main(String[] args) {
		...
		//initialisieren der target values; initialisierung der Zentren mit k-means		
				...
				double[][] centers = new double [2][90];	
				...
				KMeansPlusPlusClusterer<DoublePoint> clusterer = new KMeansPlusPlusClusterer<DoublePoint>(90);
...
//				}
				...
				JFreeChart chart = ChartFactory.createScatterPlot("90x RBF", "X1", "X2", dataset);
